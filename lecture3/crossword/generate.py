...
class CrosswordCreator():
    ...
    def ac3(self, arcs=None):
        ...
        while arcs:
            variable1, variable2 = arcs.pop()
            if self.revise(variable1, variable2):
                if not len(self.domains[variable1]):
                    return False
                
                for neighbor in self.crossword.neighbors(variable1) - {variable2}:
    ...
    def assignment_complete(self, assignment):
        ...
        """
        for word_assignment in assignment.values():
            if not word_assignment:
                return False
    ...
    def order_domain_values(self, var, assignment):
        ...
        words_values = {word: 0 for word in words}
        ...
        return sorted(words, key=lambda word: words_values[word])
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return values.
        """
        variables = [variable for variable in self.domains if variable not in assignment]
        return sorted(variables, key=lambda variable: len(self.domains[variable]) + 1 / len(self.crossword.neighbors(variable)))[0]
