...
def load_data(data_dir):
    ...
    # Iterate over each categorie folder
    for i in range(NUM_CATEGORIES):
        ...
        for filename in os.listdir(path):
            ...
            # Read, resize and store resized image as numpy ndarray
...
def get_model():
    ...
    model = tf.keras.Sequential(
        [
            ...
            layers.Conv2D(64, (4, 4), activation="relu", input_shape=(IMG_WIDTH, IMG_HEIGHT, 3)),
